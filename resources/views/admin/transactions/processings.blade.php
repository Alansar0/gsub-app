<x-layouts.admin>
    ...
    <div class="bg-[#101E2B] rounded-2xl mt-15 shadow-[0_0_20px_rgba(0,255,209,0.1)] p-6 border border-[#00FFD1]/20">
        ...
        <button class="bg-[#00FFD1] text-[#101E2B] px-5 py-2 rounded-xl font-medium mb-5 shadow-[0_0_10px_#00FFD1] hover:opacity-80 transition">
                    ...
                    @forelse($processings as $txn)
                        <tr class="border-b border-[#00FFD1]/10 hover:bg-[#182b3c] transition">
                            <td class="px-4 py-3 flex gap-3">
                                <button class="bg-[#0B1620] text-[#00FFD1] px-4 py-1.5 rounded-lg border border-[#00FFD1]/40 shadow hover:bg-[#00FFD1] hover:text-[#0B1620] transition">Refund</button>
                                <button class="bg-[#00FFD1] text-[#101E2B] px-4 py-1.5 rounded-lg shadow-[0_0_10px_#00FFD1] hover:opacity-80 transition">Success</button>
                            </td>
